// ======================================================================
// \title  ScopeLock_ExampleTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SCOPELOCK_EXAMPLE_SCOPELOCK_EXAMPLETOPOLOGY_HPP
#define SCOPELOCK_EXAMPLE_SCOPELOCK_EXAMPLETOPOLOGY_HPP
// Included for access to ScopeLock_Example::TopologyState and ScopeLock_Example::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ScopeLock_Example/Top/ScopeLock_ExampleTopologyDefs.hpp>

// Remove unnecessary ScopeLock_Example:: qualifications
 ...
 * ScopeLock_Example::TopologyState see: ScopeLock_ExampleTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ScopeLock_Example::TopologyState see: ScopeLock_ExampleTopologyDefs.hpp.
 *
