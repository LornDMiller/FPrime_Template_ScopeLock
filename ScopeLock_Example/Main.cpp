...
#include <ScopeLock_Example/Top/ScopeLock_ExampleTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    ScopeLock_Example::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    ScopeLock_Example::TopologyState inputs;
    ...
    ScopeLock_Example::setupTopology(inputs);
    ScopeLock_Example::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    ScopeLock_Example::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
